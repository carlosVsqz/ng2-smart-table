...
export declare class TbodyCreateCancelComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TbodyCreateCancelComponent, "ng2-st-tbody-create-cancel", never, { "grid": "grid"; "row": "row"; "editConfirm": "editConfirm"; }, {}, never, never>;
}
